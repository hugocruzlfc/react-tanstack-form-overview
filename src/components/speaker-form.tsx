...
import { SpeakersSchema } from "@/lib/validators";
...
export function SpeakerForm() {
  ...
  const form = useForm({
    ...
    // Injecting the Zod engine
    validators: {
      onChange: SpeakersSchema,
    },
  ...
  return (
    <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 w-full max-w-md mx-auto mt-10">
      <h2 className="text-xl font-bold text-white mb-6">Add New Speaker</h2>
      <form
        onSubmit={(e) => {
          e.preventDefault();
          e.stopPropagation();
              ...
              {field.state.value.map((_, index) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <form.Field name={`speakers[${index}].lastName`}>
                      {(subField) => (
                        <div>
